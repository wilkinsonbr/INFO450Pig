...
//This function translates the words into Pig Latin.
...
int main()
{
	...
	//The while loop allows the user to continue to run the program.
	while (again == 'y' || again == 'Y') 
{
		...
		if (myLatin.length() > 48) //Checks if the word is too long
{
			cout << "Your word is too long. Please try again" << endl;
}
		//Checks if the word starts with a number
		else if (myLatin[0] == '1' || myLatin[0] == '2' || myLatin[0] == '3' ||
			myLatin[0] == '4' || myLatin[0] == '5' || myLatin[0] == '6' ||
			myLatin[0] == '7' || myLatin[0] == '8' || myLatin[0] == '9' ||
			myLatin[0] == '0')
{
...
{
			//Sends the word to get translated
		...
		|| vowel == 'u' || vowel == 'U')
{
	...
	else if (latinWord=="the" || latinWord == "The" || latinWord == "and" 
		|| latinWord == "And" || latinWord == "but" || latinWord == "But"
		|| latinWord == "for" || latinWord == "For" || latinWord == "nor" 
		|| latinWord == "Nor" || latinWord == "yet" || latinWord == "Yet")
{
		latinWord = latinWord;
}
